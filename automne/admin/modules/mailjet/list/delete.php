...
$list = $api->contactslist(array("ID" => $listId));
if($list){
  $list = $list->Data[0];
}
...
if($submitted) {
  $listId = io::post('id');
  if(empty($errors)) {
    $response = $api->contactslist(array('method' => 'DELETE', 'ID'=> $listId));
          ...
          <div class="col-md-12 form-container">
            <?php if ($deleted): ?>
              <div class="alert alert-success">
                <strong>La liste a été supprimée.</strong> <a href="index.php">Retour</a>
              </div>
            <?php else: ?>
                ...
                <div class="widget-content nopadding">
                  ...
                  <form action="" method="post" class="form-horizontal">
                    <p style="padding: 10px;">
                      <strong>Identifiant : </strong><?php echo $list->ID?><br />
                      <strong>Nom : </strong><?php echo $list->Address?><br />
                      <strong>Titre : </strong><?php echo $list->Name?><br />
                    </p>
                    <div class="form-actions">
                      <input type="hidden" name="id" value="<?php echo $listId ?>">
                      <button type="submit" name="submit" value="1" class="btn btn-primary">Etes-vous sûr de vouloir supprimer cette liste ?</button> <a class="btn btn-inverse" href="index.php">Retour</a>
                    </div>
                  </form>
                </div>
              </div>
