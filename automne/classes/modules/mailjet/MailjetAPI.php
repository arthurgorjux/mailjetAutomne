...
class MailjetAPI
{
    ...
    # Contantes for campaign status
    const MAILJET_STATUS_SENT = 'sent';
    const MAILJET_STATUS_DRAFT = 'draft';
    const MAILJET_STATUS_ARCHIVED = 'archived';
    const MAILJET_STATUS_PROGRAMMED = 'programmed';

    # Contantes for campaign type
    const MAILJET_TYPE_NL = 'NL';
    const MAILJET_TYPE_CAMPAIGN = 'Campaign';

    # Contantes for status code returned by the Mailjet API
    const MAILJET_STATUS_CODE_OK_GET = 200;
    const MAILJET_STATUS_CODE_OK_VIEW = 200;
    const MAILJET_STATUS_CODE_OK_PUT = 200;
    const MAILJET_STATUS_CODE_OK_POST = 201;
    const MAILJET_STATUS_CODE_OK_DELETE = 204;
    const MAILJET_STATUS_CODE_OK_ERROR = 400;
    ...
    private function readWrapperVersion() {
        return MailjetAPI::WRAPPER_VERSION;
    }

    public static function getStatus($key) {
        switch ($key) {
            case MailjetAPI::MAILJET_STATUS_DRAFT:
                return 'Brouillon';
                break;
            case MailjetAPI::MAILJET_STATUS_PROGRAMMED :
                return "Programmée";
                break;
            case MailjetAPI::MAILJET_STATUS_SENT :
                return "Envoyée";
                break;
            case MailjetAPI::MAILJET_STATUS_ARCHIVED :
                return "Archivée";
                break;
            default:
                return "Inconnu";
  ...
  public static function getStatusClass($key) {
        switch ($key) {
            case MailjetAPI::MAILJET_STATUS_DRAFT:
                return 'default';
                break;
